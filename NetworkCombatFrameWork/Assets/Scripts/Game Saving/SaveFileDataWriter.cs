...
public class SaveFileDataWriter
{
    ...
    // BEFORE WE CREATE A NEW SAVE FILE, WE MUST CHECK TO SEE IF ONE OF THESE CHARACTER SLOTS ALREADY EXISTS (MAX 10 CHARACTER SLOTS)
    ...
    public CharacterSaveData LoadSaveFile()
    {
        ...
        if(File.Exists(loadPath))
        {
            ...
            {
                Debug.LogError($"ERROR WHILST TRYING TO LOAD CHARACTER DATA, GAME DATA NOT SYNCED: {loadPath} \n {ex}");
            }
        }
